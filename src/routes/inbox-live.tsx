...
function displayName(contact: Contact | undefined, phone: string | null): string { return contact?.name || displayPhone(contact?.phoneNumber ?? phone) || '' }
